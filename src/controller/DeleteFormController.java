...
public class DeleteFormController {
    ...
    public void ConformOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        if (EmployeeController.deleteEmployee((String)cmbEmpId.getValue())) {
    ...
    public void deleteEmployeeOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
